...
int main(void)
{
  ...
  sprintf(user_msg,"Demo of Task Deletion API\n\r");
  printmsg(user_msg);

  // create tasks
  xTaskCreate(vtask1_handler, "TASK-LED" , 500, NULL, 1, &xTaskHandle1);

  xTaskCreate(vtask2_handler, "TASK-BUTTON" , 500, NULL, 2, &xTaskHandle2);
